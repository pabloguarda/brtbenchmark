...
scores2013 =plyr::rename(scores2013,c(STATIONS_SET_BACK_FROM_INTERSECTIONS="c3"))
scores2013$c3 = as.numeric(scores2013$c3)
Hmisc::label(scores2013$c3) = "Stations set back from intersections"

#Center stations (c4)
scores2013 =plyr::rename(scores2013,c(CENTER_STATIONS="c4"))
scores2013$c4 = as.numeric(scores2013$c4)
Hmisc::label(scores2013$c4) = "Center stations"

#Pavement quality (c5)
scores2013 =plyr::rename(scores2013,c(PAVEMENT_QUALITY="c5"))
...
#Overall score in this item
scores2013 =plyr::rename(scores2013,c(STATION_DESIGN_AND_STATION_BUS_INTERFACE="d"))
...
scores2013 =plyr::rename(scores2013,c(DISTANCES_BETWEEN_STATIONS="d1"))
...
scores2013 =plyr::rename(scores2013,c(SLIDING_DOORS_IN_BRT_STATIONS="d5"))
...
scores2013 =plyr::rename(scores2013,c(INTEGRATION_WITH_OTHER_PUBLIC_TRANSPORT="f2"))
...
scores2013 =plyr::rename(scores2013,c(PEAK_PASSENGERS_PER_HOUR_PER_DIRECTION_PPHPD_BELOW_1_000="g2"))
...
scores2013 =plyr::rename(scores2013,c(LACK_OF_ENFORCEMENT_OF_RIGHT_OF_WAY="g3"))
...
scores2013 =plyr::rename(scores2013,c(SIGNIFICANT_GAP_BETWEEN_BUS_FLOOR_AND_STATION_PLATFORM="g4"))
scores2013$g4 = -as.numeric(scores2013$g4)
Hmisc::label(scores2013$g4) = "Significant gap between bus floor and station platform"

#Overcrowding (g5)
scores2013 =plyr::rename(scores2013,c(OVERCROWDING="g5"))
...
scores2013 =plyr::rename(scores2013,c(POORLY_MAINTAINED_BUSWAY_BUSES_STATIONS_AND_TECHNOLOGY_SYSTEMS="g6"))
...
# - Year --------------------------------------------------------------------
scores2013 =plyr::rename(scores2013,c(YEAR="year")) 
scores2013$year = as.integer(scores2013$year)
Hmisc::label(scores2013$year) = "Year"
# - Country --------------------------------------------------------------------
scores2013 =plyr::rename(scores2013,c(COUNTRY="country")); #Hmisc::label(scores2013$country) = "Country"
# - City --------------------------------------------------------------------
scores2013 =plyr::rename(scores2013,c(CITY="city")); #Hmisc::label(scores2013$city) = "City"
# - System --------------------------------------------------------------------
scores2013 =plyr::rename(scores2013,c(SYSTEM="system")); #Hmisc::label(scores2013$system) = "System"
# - Corridor Name --------------------------------------------------------------------
scores2013 =plyr::rename(scores2013,c(CORRIDOR="corridor")); #Hmisc::label(scores2013$corridor) = "Corridor name"
# - Corridor Length --------------------------------------------------------------------
scores2013 =plyr::rename(scores2013,c(CORRIDOR_LENGTH_KM="corridor_length")); #Hmisc::label(scores2013$corridor_length) = "Corridor length"
# - Score --------------------------------------------------------------------

#Without discounting point deductions (initial score)
scores2013 =plyr::rename(scores2013,c(TOTAL_100="score")); #Hmisc::label(scores2013$score) = "Score"

#Discounting point deductions
scores2013 =plyr::rename(scores2013,c(TOTAL_SCORE="total_score")); #Hmisc::label(scores2013$total_score) = "Total score"
# - Classification --------------------------------------------------------
scores2013 =plyr::rename(scores2013,c(CLASSIFICATION="classification"))
...
#Variables
itdp2014 =plyr::rename(itdp2014,c(VARIABLE="variable")); #Hmisc::label(itdp2014$variable) = "Variable"
itdp2014 =plyr::rename(itdp2014,c(ID="id")); #Hmisc::label(itdp2014$id) = "Id"
itdp2014 =plyr::rename(itdp2014,c(ITEM="item")); #Hmisc::label(itdp2014$item) = "Item"
itdp2014 =plyr::rename(itdp2014,c(MAX_SCORE="max_score")); #Hmisc::label(itdp2014$max_score) = "Max Score"
itdp2014 =plyr::rename(itdp2014,c(NOTES="notes")); #Hmisc::label(itdp2014$notes) = "Notes"

# - BRT Basics (a) ------------------------------------------------------------

#Overall score in this item
scores2014 =plyr::rename(scores2014,c(BRT_BASICS_MINIMUM_SCORE_OF_20_POINTS_NEEDED="a"))
scores2014$a = as.numeric(scores2014$a)
Hmisc::label(scores2014$a) = "BRT Basics"

# Dedicated right-of-way - Minimum 4 points (a1)
scores2014 =plyr::rename(scores2014,c(DEDICATED_RIGHT_OF_WAY_MINIMUM_4_POINTS="a1"))
Hmisc::label(scores2014$a1) = "Dedicated right-of-way"

# Busway alignment - Minimum 4 points (a2)
scores2014 =plyr::rename(scores2014,c(BUSWAY_ALIGNMENT_MINIMUM_4_POINTS="a2")); #Hmisc::label(scores2014$a2) = "Busway alignment"
...
scores2014 =plyr::rename(scores2014,c(POORLY_MAINTAINED_BUSWAY_BUSES_STATIONS_AND_TECHNOLOGY_SYSTEMS="g8"))
...
# b) General Information --------------------------------------------------
# - Year --------------------------------------------------------------------
scores2014 =plyr::rename(scores2014,c(YEAR="year"))
scores2014$year = as.integer(scores2014$year)
Hmisc::label(scores2014$year) = "Year"
# - Country --------------------------------------------------------------------
scores2014 =plyr::rename(scores2014,c(COUNTRY="country")); #Hmisc::label(scores2014$country) = "Country"
# - City --------------------------------------------------------------------
scores2014 =plyr::rename(scores2014,c(CITY="city")); #Hmisc::label(scores2014$city) = "City"
# - System --------------------------------------------------------------------
scores2014 =plyr::rename(scores2014,c(SYSTEM="system")); #Hmisc::label(scores2014$system) = "System"
...
# - Corridor Name --------------------------------------------------------------------
scores2014 =plyr::rename(scores2014,c(CORRIDOR="corridor")); #Hmisc::label(scores2014$corridor) = "Corridor name"
# - Corridor Length --------------------------------------------------------------------
scores2014 =plyr::rename(scores2014,c(CORRIDOR_LENGTH_KM="corridor_length")); #Hmisc::label(scores2014$corridor_length) = "Corridor length"
# - Score --------------------------------------------------------------------

#Without discounting point deductions (initial score)
scores2014 =plyr::rename(scores2014,c(TOTAL_100="score")); #Hmisc::label(scores2014$score) = "Score"

#Discounting point deductions
scores2014 =plyr::rename(scores2014,c(TOTAL_SCORE="total_score")); #Hmisc::label(scores2014$total_score) = "Total Score"
# - Classification --------------------------------------------------------
scores2014 =plyr::rename(scores2014,c(CLASSIFICATION="classification"))
...
# - Comments ----------------------------------------------------------------
scores2014 =plyr::rename(scores2014,c(SUGGESTIONS_FOR_QUICK_IMPROVEMENTS_1="comment1")); #Hmisc::label(scores2014$comment1) = "Suggestions for Quick Improvements 1"
scores2014 =plyr::rename(scores2014,c(SUGGESTIONS_FOR_QUICK_IMPROVEMENTS_2="comment2")); #Hmisc::label(scores2014$comment2) = "Suggestions for Quick Improvements 2"
scores2014 =plyr::rename(scores2014,c(SUGGESTIONS_FOR_QUICK_IMPROVEMENTS_3="comment3")); #Hmisc::label(scores2014$comment3) = "Suggestions for Quick Improvements 3"
...
# - Continent ---------------------------------------------------------------
brt_systems =plyr::rename(brt_systems,c(REGION="continent")); #Hmisc::label(brt_systems$continent) = "Continent"
# - Country --------------------------------------------------------------------
brt_systems =plyr::rename(brt_systems,c(COUNTRY="country")); #Hmisc::label(brt_systems$country) = "Country"
# - City --------------------------------------------------------------------
brt_systems =plyr::rename(brt_systems,c(CITY="city")); #Hmisc::label(brt_systems$city) = "City"
# - Corridor name --------------------------------------------------------------------
brt_systems =plyr::rename(brt_systems,c(SYSTEM_NAME="system")); #Hmisc::label(brt_systems$system) = "System"
# - Corridor length -------------------------------------------------------
brt_systems =plyr::rename(brt_systems,c(SYSTEM_LENGTH_KM="system_length")); #Hmisc::label(brt_systems$system_length) = "System Length (km)"
# - Population ---------------------------------------------------------------------
brt_systems =plyr::rename(brt_systems,c(POPULATION_CITY="population")); #Hmisc::label(brt_systems$population) = "Population in the city"
brt_systems$population = as.numeric(brt_systems$population)
# - Population Density ----------------------------------------------------
brt_systems =plyr::rename(brt_systems,c(POPULATION_DENSITY_METROPOLITAN_AREA="pop_density")); #Hmisc::label(brt_systems$pop_density) = "Population Density Metropolitan Area [hab/km2]"
brt_systems$pop_density = as.numeric(brt_systems$pop_density)
# - GDP ---------------------------------------------------------------------
brt_systems =plyr::rename(brt_systems,c(GDP_PER_CAPITA_US="gdp")); #Hmisc::label(brt_systems$gdp) = "GDP per capita (US$)"
brt_systems$gdp = as.numeric(brt_systems$gdp)
# - Bus Fare ---------------------------------------------------------------------
brt_systems =plyr::rename(brt_systems,c(STANDARD_FARE_US="bus_fare"))
...
brt_systems =plyr::rename(brt_systems,c(MODAL_SPLIT_PUBLIC_TRANSPORT="bus_split")); #Hmisc::label(brt_systems$bus_split) = "Modal Split in Public Transport"
# - Modal split in private transport ---------------------------------------------------------------------
brt_systems =plyr::rename(brt_systems,c(MODAL_SPLIT_PRIVATE_TRANSPORT="car_split")); #Hmisc::label(brt_systems$car_split) = "Modal Split in Private Transport"
# - System Name --------------------------------------------------------------------
# systems =plyr::rename(systems,c(SYSTEM_NAME="system")); Hmisc::label(systems$system) = "System"
# - Year System Commenced ----------------------------------------------------------
# Year when operations were inaugurated.
brt_systems =plyr::rename(brt_systems,c(YEAR_SYSTEM_COMMENCED="year_system_commenced"))
...
# - Daily Demand ----------------------------------------------------------
brt_systems =plyr::rename(brt_systems,c(DAILY_DEMAND_PASSENGERS_PER_DAY="demand"))
...
brt_systems =plyr::rename(brt_systems,c(STATION_SPACING_M="station_spacing")); 
...
brt_systems =plyr::rename(brt_systems,c(OPERATING_SPEED="speed"))
...
brt_systems =plyr::rename(brt_systems,c(PEAK_FREQUENCY_BUSES_PER_HOUR="peak_frequency"))
...
brt_systems =plyr::rename(brt_systems,c(PEAK_LOAD_PASSENGERS_PER_HOUR_PER_DIRECTION="peak_load_pax"))
...
brt_systems =plyr::rename(brt_systems,c(ANNUAL_FARE_REVENUE_US_MILLIONS="annual_revenues"))
...
# - Continent ---------------------------------------------------------------
brt_corridors =plyr::rename(brt_corridors,c(REGION="continent")); #Hmisc::label(brt_corridors$continent) = "Continent"
# - Country --------------------------------------------------------------------
brt_corridors =plyr::rename(brt_corridors,c(COUNTRY="country")); #Hmisc::label(brt_corridors$country) = "Country"
# - City --------------------------------------------------------------------
brt_corridors =plyr::rename(brt_corridors,c(CITY="city")); #Hmisc::label(brt_corridors$city) = "City"
# - Corridor name --------------------------------------------------------------------
brt_corridors =plyr::rename(brt_corridors,c(CORRIDOR="corridor")); #Hmisc::label(brt_corridors$corridor) = "Corridor"
# - Corridor length -------------------------------------------------------
brt_corridors =plyr::rename(brt_corridors,c(CORRIDOR_LENGTH_KM="corridor_length")); #Hmisc::label(brt_corridors$corridor_length) = "Corridor Length (km)"
# - Year Corridor Commenced ----------------------------------------------------------
brt_corridors =plyr::rename(brt_corridors,c(YEAR_CORRIDOR_COMMENCED="year_corridor_commenced"))
...
# - Operating speed ---------------------------------------------------------
brt_corridors =plyr::rename(brt_corridors,c(OPERATING_SPEED_CORRIDOR="speed"))
...
brt_corridors =plyr::rename(brt_corridors,c(TOTAL_COST_PER_KILOMETER_CORRIDOR_US_MILLION_PER_KM="cost_per_km"))
...
brt_corridors =plyr::rename(brt_corridors,c(PEAK_LOAD_CORRIDOR_PASSENGERS_PER_HOUR_PER_DIRECTION="peak_load"))
...
brt_corridors =plyr::rename(brt_corridors,c(PEAK_FREQUENCY_CORRIDOR_BUSES_PER_HOUR_PER_DIRECTION="peak_frequency"))
...
brt_corridors =plyr::rename(brt_corridors,c(PHYSICALLY_INTEGRATED_FEEDERS="integrated_feeders"))
...
brt_corridors =plyr::rename(brt_corridors,c(GRADE_SEPARATED_INTERSECTIONS_CORRIDOR="separated_intersections"))
...
# - Daily Demand ----------------------------------------------------------
brt_corridors =plyr::rename(brt_corridors,c(DAILY_DEMAND_CORRIDOR_PASSENGERS_PER_DAY="demand"))
brt_corridors$demand = as.numeric(brt_corridors$demand)
Hmisc::label(brt_corridors$demand) = "Demand [pax/day]"
# - Station Spacing -------------------------------------------------------
# Average distance between stations on the corridor. Data in meters.
brt_corridors =plyr::rename(brt_corridors,c(STATION_SPACING_CORRIDOR_M="station_spacing")); 
...
brt_corridors =plyr::rename(brt_corridors,c(PRE_BOARD_FARE_COLLECTION_CORRIDOR="offboard_payment"))
...
brt_corridors =plyr::rename(brt_corridors,c(LENGTH_OF_SEGREGATED_LANES_CORRIDOR_KM="segregated_lanes_length"))
...
brt_corridors =plyr::rename(brt_corridors,c(LENGTH_OF_EXCLUSIVE_LANES_CORRIDOR_KM="exclusive_lanes_length"))
...
brt_corridors =plyr::rename(brt_corridors,c(LENGTH_OF_SEGREGATED_COUNTERFLOW_LANES_CORRIDOR_KM="segregated_counterflow_lanes_length"))
...
itdp_brtdata_2017 = plyr::rename(itdp_brtdata_2017,c(CORRIDOR="corridor")); Hmisc::label(itdp_brtdata_2017$corridor) = "Corridor"
itdp_brtdata_2017 =plyr::rename(itdp_brtdata_2017,c(SYSTEM="system")); Hmisc::label(itdp_brtdata_2017$system) = "System"
itdp_brtdata_2017 =plyr::rename(itdp_brtdata_2017,c(POPULATION_DENSITY_METROPOLITAN_AREA="pop_density_2017")); Hmisc::label(itdp_brtdata_2017$pop_density_2017) = "Population density, metropolitan area"
itdp_brtdata_2017 =plyr::rename(itdp_brtdata_2017,c(PEAK_LOAD_CORRIDOR_PASSENGERS_PER_HOUR_PER_DIRECTION="peak_load_2017")); Hmisc::label(itdp_brtdata_2017$peak_load_2017) = "Peak load, corridor (passengers per hour per direction)"
itdp_brtdata_2017 =plyr::rename(itdp_brtdata_2017,c(SPEED_KPH_ITDP="speed_ITDP_2017")); Hmisc::label(itdp_brtdata_2017$speed_ITDP_2017) = "Speed (kph) ITDP"
itdp_brtdata_2017 =plyr::rename(itdp_brtdata_2017,c(SPEED_KPH_BRTDATA="speed_BRTData_2017")); Hmisc::label(itdp_brtdata_2017$speed_BRTData_2017) = "Speed (kph) BRTdata"
itdp_brtdata_2017 =plyr::rename(itdp_brtdata_2017,c(DAILY_DEMAND_CORRIDOR_PPD="demand_BRTData_2017")); Hmisc::label(itdp_brtdata_2017$demand_BRTData_2017) = "Daily demand corridor (ppd)"
itdp_brtdata_2017 =plyr::rename(itdp_brtdata_2017,c(CORRIDOR_LENGTH_KM_BRTDATA="corridor_length_BRTData_2017")); Hmisc::label(itdp_brtdata_2017$corridor_length_BRTData_2017) = "Corridor length (km) BRTdata"

itdp_brtdata_2017 =plyr::rename(itdp_brtdata_2017,c(YEAR="year")) 
itdp_brtdata_2017$year = as.integer(itdp_brtdata_2017$year)
Hmisc::label(itdp_brtdata_2017$year) = "Year"

# 5) City information -----------------------------------------------------
# - City -----------------------------------------------------------------
# countries =plyr::rename(countries,c(COUNTRY="country")); Hmisc::label(countries$country) = "Country"
...
brt_corridors = plyr::rename(brt_corridors,c(city="city_BRTData"))
...
brt_systems = plyr::rename(brt_systems,c(city="city_BRTData"))
...
scores2013 = plyr::rename(scores2013,c(city="city_ITDP"))
scores2013 = merge(scores2013,temp_cities[c("city","city_ITDP")],by="city_ITDP",all.x=TRUE)
scores2014 = plyr::rename(scores2014,c(city="city_ITDP"))
...
brt_corridors = plyr::rename(brt_corridors,c(country="country_BRTData"))
...
brt_systems = plyr::rename(brt_systems,c(country="country_BRTData"))
...
scores2013 = plyr::rename(scores2013,c(country="country_ITDP"))
...
scores2014 = plyr::rename(scores2014,c(country="country_ITDP"))
...
# 7) Metro ----------------------------------------------------------------
# - Continent ---------------------------------------------------------------
metro =plyr::rename(metro,c(CONTINENT="continent")); Hmisc::label(metro$continent) = "Continent"
# - Country --------------------------------------------------------------------
metro =plyr::rename(metro,c(COUNTRY="country")); Hmisc::label(metro$country) = "Country"
# - City --------------------------------------------------------------------
metro =plyr::rename(metro,c(CITY="city")); Hmisc::label(metro$city) = "City"
# - Year Metro Commenced ----------------------------------------------------------

metro =plyr::rename(metro,c(OPENING="date_metro_commenced")); Hmisc::label(metro$date_metro_commenced) = "Date Metro Commenced"
...
metro =plyr::rename(metro,c(NETWORK_LENGTH="metro_length")); Hmisc::label(metro$metro_length) = "Network Length (km)"
...
brt_km_city =plyr::rename(brt_km_city,c(x="corridors_city_length"))
